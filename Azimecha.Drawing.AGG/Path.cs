...
namespace Azimecha.Drawing.AGG {
    public class Path : IPath {
        ...
        public Path() {
            _hPath.TakeObject(Interop.Functions.Loader.GetMethod<Interop.Functions.AwCreatePath>()(), true);
        ...
        public void AddArc(float x, float y, float w, float h, float fStartAngle, float fSweepAngle) {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwAddPathArc>()(_hPath.Handle, x, y, w, h, fStartAngle, fSweepAngle))
        ...
        public void AddChord(float x, float y, float w, float h, float fStartAngle, float fSweepAngle) {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwAddPathChord>()(_hPath.Handle, x, y, w, h, fStartAngle, fSweepAngle))
                throw new PathOperationFailedException($"Error adding chord to path");
        }

        public void AddCircle(float x, float y, float fRadius) {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwAddPathCircle>()(_hPath.Handle, x, y, fRadius))
                throw new PathOperationFailedException($"Error adding circle to path");
        }

        public void AddEllipse(float x, float y, float w, float h) {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwAddPathEllipse>()(_hPath.Handle, x, y, w, h))
                throw new PathOperationFailedException($"Error adding ellipse to path");
        }

        public void AddLine(float x1, float y1, float x2, float y2) {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwAddPathLine>()(_hPath.Handle, x1, y1, x2, y2))
                throw new PathOperationFailedException($"Error adding line to path");
        }

        public void AddPath(IPath path) {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwAddPath>()(_hPath.Handle, ((Path)path)._hPath.Handle))
        ...
        public void AddPieSlice(float x, float y, float w, float h, float fStartAngle, float fSweepAngle) {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwAddPathPieSlice>()(_hPath.Handle, x, y, w, h, fStartAngle, fSweepAngle))
        ...
        public void AddPolygon(IEnumerable<PointF> enuPoints) {
            ...
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwAddPathPolygon>()(_hPath.Handle, arrPoints, arrPoints.Length))
                throw new PathOperationFailedException($"Error adding polygon to path");
        }

        public void AddPolyline(IEnumerable<PointF> enuPoints) {
            Interop.AwPathPoint[] arrPoints = ConvertPoints(enuPoints);
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwAddPathPolyline>()(_hPath.Handle, arrPoints, arrPoints.Length))
        ...
        public void AddRectangle(float x, float y, float w, float h) {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwAddPathRectangle>()(_hPath.Handle, x, y, w, h))
        ...
        public void AddRoundedRectangle(float x, float y, float w, float h, float fRadius) {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwAddPathRoundedRectangle>()(_hPath.Handle, x, y, w, h, fRadius))
        ...
        public void AddTriangle(float x1, float y1, float x2, float y2, float x3, float y3) {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwAddPathTriangle>()(_hPath.Handle, x1, y1, x2, y2, x3, y3))
                throw new PathOperationFailedException($"Error adding triangle to path");
        }

        public void Clear() {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwClearPath>()(_hPath.Handle))
                throw new PathOperationFailedException($"Error clearing path");
        }

        public void CloseShape() {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwClosePathShape>()(_hPath.Handle))
        ...
        public void LineTo(float x, float y) {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwPathLineTo>()(_hPath.Handle, x, y))
                throw new PathOperationFailedException($"Error adding line to position X={x} Y={y}");
        }

        public void MoveTo(float x, float y) {
            if (!Interop.Functions.Loader.GetMethod<Interop.Functions.AwPathMoveTo>()(_hPath.Handle, x, y))
